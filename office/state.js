...
window.AI_STATE = {
  ...
  employees: [
    { name: "ミク", status: "idle", taskId: "" },
    { name: "ソラ", status: "idle", taskId: "" },
    { name: "アヤ", status: "idle", taskId: "" },
    { name: "ケン", status: "idle", taskId: "" },
  ],

  links: [],

  activity: [
    { time: "00:00", who: "アイ", text: "SNS大学、設立しました！Masahiro社長のご就任おめでとうございます🎉" },
  ],

  command: { id: "founding-001", type: "founding" },
};
